...
{#snippet sectionFields(fields: FieldModel[])}
	<div class="qm-fields qm-capacity">
...
<style>
	...
	/* The grid the capacity lands on; the ladder itself is `.qm-capacity` (controls.css),
	 which a nested subform walks again over its own width. */
	.qm-fields {
		display: grid;
